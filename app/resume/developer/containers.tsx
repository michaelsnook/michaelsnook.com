...
export function Wrapper({ children }: HasChildren) {
	return (
		<div className="bg-gray-300 print:bg-white md:py-10 px-1 print:p-0">
			<div className="grid grid-cols-1 md:grid-cols-4 md:shadow-[rgba(0,_0,_0,_0.3)_0px_0px_15px_5px] print:shadow-none md:rounded bg-white p-2 mx-auto min-[1060px]:w-[1050px] min-[1060px]:h-[1485px]">
				{children}
			</div>
		</div>
	)
